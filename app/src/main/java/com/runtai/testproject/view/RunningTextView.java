 ...
 * 描述：播放数字动画类
 *
 * 一、设置跳跃的帧数，setFrames(int frames)，默认是25帧
 * 二、设置数字格式 ， setFormat(String pattern)，具体查DecimalFormat类的api
 * 三、需要动画效果用，playNumber(double number)方法代替setText()方法，小数如果超过3位小数会四舍五入保留2位小数
 */
public class RunningTextView extends TextView {

    public double content;// 最后显示的数字
    private int frames = 50;// 总共跳跃的帧数,默认25跳
