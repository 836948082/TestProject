 ...
 * 按钮动画
 */
public class AnimationButtonView extends View {
    ...
    private static String mTitleText = "SHARE";
    ...
    public AnimationButtonView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimationButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.setDrawFilter(new PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG));//设置图形、图片的抗锯齿。可用于线条等
    ...
    private int dip2px(float dipValue) {
        final float scale = getContext().getResources().getDisplayMetrics().density;//获取手机屏幕参数.desity
