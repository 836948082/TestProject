...
/**
 * @作者：高炎鹏
 * @日期：2016/10/29时间16:00
 * @描述：几个ListView一起联动
 */
public class ConnectListViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_listview);
        initView();
        initData();
        initFirstListView();
    }
            ...
            if (strings != null && strings.length > 0) {
                ...
                listViewThird.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(ConnectListViewActivity.this, position + " --->> " + thirdList.get(position), Toast.LENGTH_SHORT).show();
                    }
                });
            } else {
