package com.runtai.testproject.activity.clickdeflect;
...
public class DeflectImageView extends ImageView {
	...
	public DeflectImageView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}

	public DeflectImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}
