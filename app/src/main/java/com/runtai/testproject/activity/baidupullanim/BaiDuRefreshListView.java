...
public class BaiDuRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void init(Context context) {
        ...
        //加载头布局
        headView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.baidu_pull_headview, this, false);
        //测量头布局
        ...
        //获取动画
        wheelAnimation = AnimationUtils.loadAnimation(context, R.anim.tip_2);
        sunAnimation = AnimationUtils.loadAnimation(context, R.anim.tip_1);
        LinearInterpolator lir = new LinearInterpolator();
        wheelAnimation.setInterpolator(lir);
        sunAnimation.setInterpolator(lir);

        backAnimation1 = AnimationUtils.loadAnimation(context, R.anim.tip_3);
        backAnimation2 = AnimationUtils.loadAnimation(context, R.anim.tip_4);
        AccelerateDecelerateInterpolator adi = new AccelerateDecelerateInterpolator();
        backAnimation1.setInterpolator(adi);
        backAnimation2.setInterpolator(adi);
