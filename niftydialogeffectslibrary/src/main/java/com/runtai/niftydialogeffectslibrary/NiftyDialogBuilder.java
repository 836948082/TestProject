...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public NiftyDialogBuilder setPositiveButton(final View.OnClickListener click) {
    ...
    public NiftyDialogBuilder setNegativeButton(final View.OnClickListener click) {
