...
public class PullToRefreshLayout extends RelativeLayout {
	...
	// 下拉箭头的转180°动画
	private RotateAnimation rotateAnimation_back;
	// 均匀旋转动画
	...
	private void initView(Context context) {
		...
		rotateAnimation_back = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.reverse_back_anim);
	...
	private void changeState(int to) {
		...
		case INIT:
			...
			pullView.startAnimation(rotateAnimation_back);
			// 上拉布局初始状态
			loadStateImageView.setVisibility(View.GONE);
			loadStateTextView.setText(R.string.pullup_to_load);
			pullUpView.clearAnimation();
			pullUpView.setVisibility(View.VISIBLE);
			pullUpView.startAnimation(rotateAnimation_back);
			break;
